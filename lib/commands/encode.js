...
function encode(cliObj) {
  ...
  let getRandomNumber = sfc32(seedNum(), seedNum(), seedNum(), seedNum())
...
const encodeCommand = {
  ...
  args: {
    ...
    typos: {
      default: 0,
      required: false,
      info: `this number affects how many characters
                the word picker can remove from a word
                to fit the encoding.`
    },
    'max-lines': {
      required: false,
      info: `if your words corpus is very large, you can limit
