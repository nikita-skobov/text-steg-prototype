...
async function wordifyFunc(cliObj, fileWords, fillCharMap, charMap, randomFunc) {
  ...
  console.log(`file had ${fileWords.length / 2} bytes, ie: ${fileWords.length} words to wordify`)
  console.log(`Successfully filled ${succCount + skipCount} words`)
  console.log(`of the ${succCount + skipCount} words, ${skipCount} were 'skip' words`)
  console.log(`of the ${succCount} non-skip words, ${typoCount} were used with a typo`)
  console.log(`Failed to find a word ${failCount} times`)
  console.log(`Average bits per word: ${((fileWords.length / 2) * 8) / (succCount + skipCount)}\n`)
